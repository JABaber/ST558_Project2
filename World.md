...
-   [Channel of Interest: World](#channel-of-interest-world)
...
```
    ...
    ## [14] "weekday_is_wednesday"        
    ## [15] "weekday_is_thursday"         
    ## [16] "weekday_is_friday"           
    ## [17] "weekday_is_saturday"         
    ## [18] "weekday_is_sunday"           
    ## [19] "is_weekend"                  
    ## [20] "global_subjectivity"         
    ## [21] "global_sentiment_polarity"   
    ## [22] "global_rate_positive_words"  
    ## [23] "global_rate_negative_words"  
    ## [24] "avg_positive_polarity"       
    ## [25] "avg_negative_polarity"       
    ## [26] "abs_title_subjectivity"      
    ## [27] "abs_title_sentiment_polarity"
    ## [28] "shares"
...
```
    ...
    ## Warning: Removed 1212 rows containing non-finite values
    ## (stat_boxplot).
...
```
    ...
    ## 1 Monday        2180.      1100        43     62000    4432.
    ## 2 Tuesday       2277.      1100        45    115700    6302.
    ## 3 Wednesday     1878.      1100        48     53500    2934.
    ## 4 Thursday      2105.      1100        41     59400    4168.
    ## 5 Friday        2171.      1100        35    128500    5528.
    ## 6 Saturday      2713.      1500        43     75500    5072.
    ## 7 Sunday        2733.      1400        89     55600    5088.
...
```
    ...
    ## 1     10.2    9.26      2.82     5.15     0.547     1.61
...
```
    ...
    ## Warning: Removed 274 rows containing non-finite values
    ## (stat_boxplot).
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 8.293404e+03 1.363673e-02 2.080587e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 8.236224e+03 2.072422e-02 1.995274e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 8.241647e+03 2.361166e-02 1.997935e+03
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 8.244879e+03 2.589952e-02 2.006148e+03
...
```
    ...
    ##                   RMSE      MAE
    ## Lasso         8293.404 2080.587
    ## Poisson       8236.224 1995.274
    ## Boosted Tree  8241.647 1997.935
    ## Random Forest 8244.879 2006.148
...
The best model for predicting shares in the World category was the
Poisson model.
