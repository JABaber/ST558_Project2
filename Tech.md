...
```
    ...
    ## Warning: Removed 910 rows containing non-finite values
    ## (stat_boxplot).
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 5.435895e+03 1.950873e-02 2.331577e+03
...
```
    ...
    ## Random Forest 5435.895 2331.577
...
The best model for predicting shares in the Tech category was the Random
Forest model.
