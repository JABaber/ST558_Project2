...
```
    ...
    ## Warning: Removed 281 rows containing non-finite values
    ## (stat_boxplot).
...
![](Social%20Media_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Social%20Media_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
```
    ...
    ##         RMSE     Rsquared          MAE 
    ## 5.676158e+03 6.613999e-02 2.738322e+03
...
```
    ...
    ## Random Forest 5676.158 2738.322
